  ...
  render() {
    ...
    return <div className={classes}>
      ...
      <div className='atom-debug-ui-action-buttons'>
        <button title="Attach" className={(!state.visibleButtons.attach ? 'btn-hidden ' : '') + "btn btn-action octicon icon-playback-play inline-block-tight"} disabled={!state.buttons.attach} onclick={this.handleAttach}>
          <span className="btn-text">Attach</span>
        </button>
        <button title="Launch" className={(!state.visibleButtons.run ? 'btn-hidden ' : '') +"btn btn-action octicon icon-playback-play inline-block-tight"} disabled={!state.buttons.run} onclick={this.handleRun}>
          <span className="btn-text">Launch</span>
        </button>
        <button title="Continue" className={(!state.visibleButtons.continue ? 'btn-hidden ' : '') +"btn btn-action octicon icon-playback-play inline-block-tight"} disabled={!state.buttons.continue} onclick={this.handleContinueDebugging}>
          <span className="btn-text">Continue</span>
        </button>
        <button title="Step Over" className={(!state.visibleButtons.stepover ? 'btn-hidden ' : '') +"btn btn-action octicon icon-steps inline-block-tight"} disabled={!state.buttons.stepover} onclick={this.handleStepOver}>
          <span className="btn-text"> Step Over</span>
        </button>
        <button title="Step In" className={(!state.visibleButtons.stepin ? 'btn-hidden ' : '') +"btn btn-action octicon icon-sign-in inline-block-tight"} disabled={!state.buttons.stepin} onclick={this.handleStepIn}>
          <span className="btn-text">Step In</span>
        </button>
        <button title="Step Out" className={(!state.visibleButtons.stepout ? 'btn-hidden ' : '') +"btn btn-action octicon icon-sign-out inline-block-tight"} disabled={!state.buttons.stepout} onClick={this.handleStepOut}>
          <span className="btn-text">Step Out</span>
        </button>
        <button title="Stop" className={(!state.visibleButtons.stop ? 'btn-hidden ' : '') +"btn btn-action octicon icon-primitive-square inline-block-tight"} disabled={!state.buttons.stop}  onClick={this.handleStopDebugging}>
          <span className="btn-text">Stop</span>
        </button>
        <button title="Detach" className={(!state.visibleButtons.detach ? 'btn-hidden ' : '') +"btn btn-action octicon icon-zap inline-block-tight"} disabled={!state.buttons.detach}  onClick={this.handleDetach}>
