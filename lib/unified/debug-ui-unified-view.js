...
export class UnifiedView extends UiComponent {
  ...
  render() {
    ...
    if (viewService.isPanelEnabled('stack')) {
      stackView = <Collapsable className="atom-debug-ui-tab" expanded={state.tabs.stackView.expanded} closed={state.tabs.stackView.closed} name='stackView' title='Stacktrace' onClose={this.handleCloseChange} onChange={this.handleCollapseChange}>
